...
export class JoinRequest extends jspb.Message {
  ...
  hasConfig(): boolean;
  clearConfig(): void;
  getConfig(): JoinRequest.Config | undefined;
  setConfig(value?: JoinRequest.Config): void;
...
export namespace JoinRequest {
  export type AsObject = {
    sid: string,
    uid: string,
    config?: JoinRequest.Config.AsObject,
    description: Uint8Array | string,
  }
  ...
  export class Config extends jspb.Message {
    ...
    getNosubscribe(): boolean;
    setNosubscribe(value: boolean): void;
