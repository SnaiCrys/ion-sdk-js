...
goog.exportSymbol('proto.sfu.JoinRequest.Config', null, global);
...
proto.sfu.JoinRequest.toObject = function(includeInstance, msg) {
  var f, obj = {
    ...
    config: (f = msg.getConfig()) && proto.sfu.JoinRequest.Config.toObject(includeInstance, f),
    description: msg.getDescription_asB64()
  };
...
proto.sfu.JoinRequest.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    ...
    case 2:
      ...
      break;
    case 3:
      var value = new proto.sfu.JoinRequest.Config;
      reader.readMessage(value,proto.sfu.JoinRequest.Config.deserializeBinaryFromReader);
      msg.setConfig(value);
      break;
    case 4:
      var value = /** @type {!Uint8Array} */ (reader.readBytes());
...
proto.sfu.JoinRequest.serializeBinaryToWriter = function(message, writer) {
  ...
  if (f != null) {
    writer.writeMessage(
      3,
      f,
      proto.sfu.JoinRequest.Config.serializeBinaryToWriter
    );
  }
 ...
 * @constructor
 */
proto.sfu.JoinRequest.Config = function(opt_data) {
  jspb.Message.initialize(this, opt_data, 0, -1, null, null);
};
goog.inherits(proto.sfu.JoinRequest.Config, jspb.Message);
if (goog.DEBUG && !COMPILED) {
  proto.sfu.JoinRequest.Config.displayName = 'proto.sfu.JoinRequest.Config';
}
 ...
 * @return {!Object}
 */
proto.sfu.JoinRequest.Config.prototype.toObject = function(opt_includeInstance) {
  return proto.sfu.JoinRequest.Config.toObject(opt_includeInstance, this);
};
 ...
 *     instance for transitional soy proto support:
 *     http://goto/soy-param-migration
 * @param {!proto.sfu.JoinRequest.Config} msg The msg instance to transform.
 * @return {!Object}
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.sfu.JoinRequest.Config.toObject = function(includeInstance, msg) {
  var f, obj = {
    nopublish: jspb.Message.getFieldWithDefault(msg, 1, false),
    nosubscribe: jspb.Message.getFieldWithDefault(msg, 2, false)
  };
 ...
 * Deserializes binary data (in protobuf wire format).
 * @param {jspb.ByteSource} bytes The bytes to deserialize.
 * @return {!proto.sfu.JoinRequest.Config}
 */
proto.sfu.JoinRequest.Config.deserializeBinary = function(bytes) {
  var reader = new jspb.BinaryReader(bytes);
  var msg = new proto.sfu.JoinRequest.Config;
  return proto.sfu.JoinRequest.Config.deserializeBinaryFromReader(msg, reader);
};
 ...
 * Deserializes binary data (in protobuf wire format) from the
 * given reader into the given message object.
 * @param {!proto.sfu.JoinRequest.Config} msg The message object to deserialize into.
 * @param {!jspb.BinaryReader} reader The BinaryReader to use.
 * @return {!proto.sfu.JoinRequest.Config}
 */
proto.sfu.JoinRequest.Config.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    if (reader.isEndGroup()) {
      break;
    }
 ...
 * @return {!Uint8Array}
 */
proto.sfu.JoinRequest.Config.prototype.serializeBinary = function() {
  var writer = new jspb.BinaryWriter();
  proto.sfu.JoinRequest.Config.serializeBinaryToWriter(this, writer);
  return writer.getResultBuffer();
};
 ...
 * Serializes the given message to binary data (in protobuf wire
 * format), writing to the given BinaryWriter.
 * @param {!proto.sfu.JoinRequest.Config} message
 * @param {!jspb.BinaryWriter} writer
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.sfu.JoinRequest.Config.serializeBinaryToWriter = function(message, writer) {
  var f = undefined;
...
/**
 * optional bool NoPublish = 1;
 * Note that Boolean fields may be set to 0/1 when serialized from a Java server.
 * You should avoid comparisons like {@code val === true/false} in those cases.
 * @return {boolean}
 */
proto.sfu.JoinRequest.Config.prototype.getNopublish = function() {
  return /** @type {boolean} */ (jspb.Message.getFieldWithDefault(this, 1, false));
};


/** @param {boolean} value */
proto.sfu.JoinRequest.Config.prototype.setNopublish = function(value) {
  jspb.Message.setProto3BooleanField(this, 1, value);
};


/**
 * optional bool NoSubscribe = 2;
 * Note that Boolean fields may be set to 0/1 when serialized from a Java server.
 * You should avoid comparisons like {@code val === true/false} in those cases.
 * @return {boolean}
 */
proto.sfu.JoinRequest.Config.prototype.getNosubscribe = function() {
  return /** @type {boolean} */ (jspb.Message.getFieldWithDefault(this, 2, false));
};


/** @param {boolean} value */
proto.sfu.JoinRequest.Config.prototype.setNosubscribe = function(value) {
 ...
 * @return {?proto.sfu.JoinRequest.Config}
 */
proto.sfu.JoinRequest.prototype.getConfig = function() {
  return /** @type{?proto.sfu.JoinRequest.Config} */ (
    jspb.Message.getWrapperField(this, proto.sfu.JoinRequest.Config, 3));
};


/** @param {?proto.sfu.JoinRequest.Config|undefined} value */
proto.sfu.JoinRequest.prototype.setConfig = function(value) {
  jspb.Message.setWrapperField(this, 3, value);
};


proto.sfu.JoinRequest.prototype.clearConfig = function() {
 ...
 * @return {!boolean}
 */
proto.sfu.JoinRequest.prototype.hasConfig = function() {
  return jspb.Message.getField(this, 3) != null;
};
